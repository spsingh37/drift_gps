\hypertarget{md__home_neofelis_VRX_drift_README_autotoc_md1}{}\doxysection{Description}\label{md__home_neofelis_VRX_drift_README_autotoc_md1}
Dead Reckoning In Field Time (DRIFT) is an open-\/source C++ software library designed to provide accurate and high-\/frequency proprioceptive state estimation for a variety of mobile robot architectures. By default, DRIFT supports legged robots, differential-\/drive wheeled robots, full-\/size vehicles with shaft encoders and marine robots with a Doppler Velocity Log (DVL). Leveraging symmetry-\/preserving filters such as \href{https://www.annualreviews.org/doi/10.1146/annurev-control-060117-105010}{\texttt{ Invariant Kalman Filtering (In\+EKF)}}, this modular library empowers roboticists and engineers with a robust and adaptable tool to estimate instantaneous local pose and velocity in diverse environments. The software is structured in a modular fashion, allowing users to define their own sensor types, and propagation and correction methods, offering a high degree of customization.

Detailed documentations and tutorials can be found at \href{https://umich-curly.github.io/DRIFT_Website/}{\texttt{ https\+://umich-\/curly.\+github.\+io/\+DRIFT\+\_\+\+Website/}}.\hypertarget{md__home_neofelis_VRX_drift_README_autotoc_md2}{}\doxysection{Framework}\label{md__home_neofelis_VRX_drift_README_autotoc_md2}
\hypertarget{md__home_neofelis_VRX_drift_README_autotoc_md3}{}\doxysection{Run Time Analysis}\label{md__home_neofelis_VRX_drift_README_autotoc_md3}
We perform runtime evaluations using a personal laptop with an Intel i5-\/11400H CPU and an NVIDIA Jetson AGX Xavier (CPU). DRIFT can operate at an extremely high frequency using CPU-\/only computation, even on the resourced-\/constrained Jetson AGX Xavier. For the optional contact estimator, the inference speed on an NVIDIA RTX 3090 GPU is approximately 1100 Hz, and the inference speed on a Jetson AGX Xavier (GPU) is around 830 Hz after Tensor\+RT optimization.

\hypertarget{md__home_neofelis_VRX_drift_README_autotoc_md4}{}\doxysection{Dependencies}\label{md__home_neofelis_VRX_drift_README_autotoc_md4}
...
Building with ROS1 is optional. Instructions are \href{https://github.com/UMich-CURLY/drift/tree/main\#4-ros}{\texttt{ found below}}.\hypertarget{md__home_neofelis_VRX_drift_README_autotoc_md5}{}\doxysection{Building DRIFT library}\label{md__home_neofelis_VRX_drift_README_autotoc_md5}
...
\end{DoxyCode}
\hypertarget{md__home_neofelis_VRX_drift_README_autotoc_md6}{}\doxysubsection{Install the library}\label{md__home_neofelis_VRX_drift_README_autotoc_md6}
...
\end{DoxyCode}
\hypertarget{md__home_neofelis_VRX_drift_README_autotoc_md7}{}\doxysection{ROS}\label{md__home_neofelis_VRX_drift_README_autotoc_md7}
\hypertarget{md__home_neofelis_VRX_drift_README_autotoc_md8}{}\doxysubsection{Examples}\label{md__home_neofelis_VRX_drift_README_autotoc_md8}
We provide several examples in the {\ttfamily ROS/examples} directory.\hypertarget{md__home_neofelis_VRX_drift_README_autotoc_md9}{}\doxysubsection{Building the ROS1 node}\label{md__home_neofelis_VRX_drift_README_autotoc_md9}
...
\end{DoxyEnumerate}\hypertarget{md__home_neofelis_VRX_drift_README_autotoc_md10}{}\doxysubsection{Run examples}\label{md__home_neofelis_VRX_drift_README_autotoc_md10}
...
\end{DoxyCode}
\hypertarget{md__home_neofelis_VRX_drift_README_autotoc_md11}{}\doxysubsection{Run the repo with your own robots\+:}\label{md__home_neofelis_VRX_drift_README_autotoc_md11}
Please refer to the tutorial here\+: \href{https://umich-curly.github.io/DRIFT_Website/tutorials/}{\texttt{ https\+://umich-\/curly.\+github.\+io/\+DRIFT\+\_\+\+Website/tutorials/}}.\hypertarget{md__home_neofelis_VRX_drift_README_autotoc_md12}{}\doxysection{Contact Estimation}\label{md__home_neofelis_VRX_drift_README_autotoc_md12}
The contact estimation and the contact data set can be found in \href{https://github.com/UMich-CURLY/deep-contact-estimator}{\texttt{ https\+://github.\+com/\+UMich-\/\+CURLY/deep-\/contact-\/estimator}}.\hypertarget{md__home_neofelis_VRX_drift_README_autotoc_md13}{}\doxysection{Citations}\label{md__home_neofelis_VRX_drift_README_autotoc_md13}
...
\end{DoxyItemize}\hypertarget{md__home_neofelis_VRX_drift_README_autotoc_md14}{}\doxysection{License}\label{md__home_neofelis_VRX_drift_README_autotoc_md14}
